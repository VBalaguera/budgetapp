...
To facilitate using different forms for different functions, I created two: AuthForm.js (login):
      ...
      >
        {({ isSubmitting }) => (
          <Form>
            <div className='d-flex flex-column w-50'>
              <>
                <Field type='text' name='name' placeholder='your username' />
